  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text
            style={[styles.label, { color: colors.gray, marginBottom: 20 }]}
          >
            An otp has been sent to {phoneNumber}. Please enter it down below to
          ...
          <View style={styles.optTextSign}>
            ...
            <TouchableOpacity onPress={initiateOTP}>
